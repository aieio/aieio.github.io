...
$( document ).ready(function() {
    ...
    /*$(window).scroll(function() {
        var scrollMoreVar = $(window).scrollTop();
        if(scrollMoreVar > positionScrollInitial) {
        ...
        scrollMoreVar = positionScrollInitial;
        console.log('nuovo valore: '+ positionScrollInitial);
    });*/
    ...
    $(".scroll-more").hover(function(){
          if(scrollDownCheck){
            console.log("sto scrollando giu sul bootm");
            $('html,body').animate({
                scrollTop: $("#projects").offset().top},
                1000);
          } else {
            console.log("non sto scrollando giu sul bootm");
          }
      });*/
